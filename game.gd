...
static func manifest() -> GameManifest:
	...
	game.copy = {
		...
		"instructions_rules": (
			...
			+ "Two checkpoint flags save your place only after you collect the earlier plugs. "
			+ "A roof strike or fall automatically recovers the car; Recover also works "
			+ "when stuck. Pickups are kept. Every recovery adds FIVE seconds.\n"
			+ "The clock starts when you drive and stops while paused. No time limit or lives. "
		...
		"instructions_player_one_controls": (
			...
			+ "left trigger reverses, left stick tilts, A brakes and Y recovers. "
